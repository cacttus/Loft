...
namespace PirateCraft
{
  ...
  public class VertexFormat
  {
    ...
    public static VertexFormat DeclareVertexFormat<T>()
    {
      ...
      vft.VertexSizeBytes = Marshal.SizeOf(default(T));
  ...
  public struct v_v3n3x2
  {
    ...
    public static VertexFormat VertexFormat = VertexFormat.DeclareVertexFormat<v_v3n3x2>();
  }
  //GlobVert
  [Serializable]
  [StructLayout(LayoutKind.Sequential)]
  public struct v_v3c3n3x2u1
  {
    public vec3 _v; //3   = 3
    public vec3 _c; //3   = 6
    public vec3 _n; //3   = 9
